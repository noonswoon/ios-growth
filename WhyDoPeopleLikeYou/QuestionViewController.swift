...
class QuestionViewController: UIViewController {
    ...
    func setQuestionLabel (questionText: String) {
        ...
        question.font = UIFont(name: "Supermarket", size: 20)
        question.font.fontWithSize(21)
        question.center.x = self.view.center.x
        question.center.y = self.view.frame.height * 0.45
    ...
    func setContentBackgroundImageView () {
        ...
        setContentBackgroundImage_ForPMickey()
        // setContentBackgroundImage()
        // setCoverBackgroundImage()
        // setBlurBackgroundImage()
    }
    
    func setContentBackgroundImage_ForPMickey() {
    ...
    func generateChoice (position: CGFloat) {
        ...
        for (var i=0 ; i<choices.count ; i++) {
            ...
            var button = UICustomButton(frame: frame)
            button.titleLabel?.font = UIFont(name: "Supermarket", size: 21)
